...
/* a 装饰线没有，颜色默认灰色 */
.page{ position: absolute; left:0; right:0; top:0; bottom:.49rem; overflow: auto;background-color: #fff; }
...
#nav{ 
  ...
  /* 阴影 x y 模糊 颜色值 */
  width: 100%; position: absolute; left:0; right:0; bottom:0; height: .49rem;
  /* 固定再页面底部 高度49 */
   }
#nav a{ 
  flex:1; 
